...
def train_decoupled_features_ranker_v30():
    try:
        send_discord_notification(URL, "🚀 [Step 30] Decoupled Features Ranker V30 Training Started...")
        
        train_data_path = 'step30_feature_decoupling/train_ranker_v30.csv'
        ...
        success_msg = (
            f"✅ [Step 30] Decoupled Features Ranker V30 Training Finished!\n"
        ...
        error_msg = f"❌ [Step 30] Training ERROR:\n{str(e)}\n\n{traceback.format_exc()}"
        send_discord_notification(URL, error_msg)
        print(error_msg)
        raise e

if __name__ == "__main__":
    train_decoupled_features_ranker_v30()
