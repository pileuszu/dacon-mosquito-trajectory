...
def prepare_step33_data():
    ...
    print("Preparing Step 33 Curvature-Adaptive Ranker Data...")
    ...
    slow_path = Path("step33_curvature_adaptive/train_ranker_v33_slow.csv")
    ...
    fast_path = Path("step33_curvature_adaptive/train_ranker_v33_fast.csv")
