...
from model import Sota2026TrajectoryModel, extract_features, SotaFocalSoftHitLoss
...
def main():
    ...
    send_discord_notification(
        None,
        f"🚀 Started: [Step 55 train_automl.py] Training 5-fold 2026 SOTA Model (Mamba + Clifford)...\n"
    ...
    try:
        ...
        # Load dataset
        data_dir = Path("step55_sota_2026/data")
        ...
        models_dir = Path("step55_sota_2026/models")
        ...
        for fold in range(args.folds):
            ...
            # Create Model
            model = Sota2026TrajectoryModel(feature_dim=38, latent_dim=64, num_candidates=36).to(device)
        ...
        np.save("step55_sota_2026/data/oof_preds_soft.npy", oof_preds)
        print("Saved OOF predictions to step55_sota_2026/data/oof_preds_soft.npy")
        
        success_msg = (
            f"✅ Finished: [Step 55 train_automl.py] SOTA 2026 Mamba-Clifford Model Training Complete!\n"
        ...
        error_msg = f"❌ Failed: [Step 55 train_automl.py]\nError: {str(e)}\n\nTraceback:\n{traceback.format_exc()}"
