...
def train_regime_model(regime_name, train_data_path, model_path, time_limit):
    try:
        send_discord_notification(URL, f"🚀 [Step 33] Regime Ranker V33 ({regime_name}) Training Started...")
        ...
        success_msg = (
            f"✅ [Step 33] Regime Ranker V33 ({regime_name}) Training Finished!\n"
        ...
        error_msg = f"❌ [Step 33] Training ERROR ({regime_name}):\n{str(e)}\n\n{traceback.format_exc()}"
...
def main():
    ...
    train_regime_model(
        regime_name="SLOW",
        train_data_path="step33_curvature_adaptive/train_ranker_v33_slow.csv",
        model_path="step33_curvature_adaptive/models/ranker_v33_slow",
        time_limit=5400
    )
    
    train_regime_model(
        regime_name="FAST",
        train_data_path="step33_curvature_adaptive/train_ranker_v33_fast.csv",
        model_path="step33_curvature_adaptive/models/ranker_v33_fast",
        time_limit=5400
    )
