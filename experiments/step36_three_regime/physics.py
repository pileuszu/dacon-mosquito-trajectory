...
def make_candidates(x, priors, end_idx=-1, horizon=2, regime=None):
    ...
    # 1. Routing logic for 3-Regime Setup
    acc_type = "w5"
    if regime is not None:
        ...
        # Fallback to behavior heuristics if regime is not provided
    ...
    # 2. Select smoothed acceleration vector based on acc_type
