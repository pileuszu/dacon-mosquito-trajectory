...
def main():
    send_discord_notification(
        None,
        "🚀 Started: [Step 57 inference.py] Generating Step 57 Spatiotemporal model test predictions..."
    )
    ...
    try:
        ...
        out_dir = Path("outputs/step57_spatiotemporal_ai")
        ...
        # 2. Perform 5-fold ensemble predictions
        ...
        for fold in range(5):
            ...
            with torch.no_grad():
                ...
                # Predict
                fold_pred_2step = model.predict(test_tensor_dev, ft_te, df_c, df_s, candidates_te, steps=2)
                fold_pred_1step = model.predict(test_tensor_dev, ft_te, df_c, df_s, candidates_te, steps=1)
        ...
        # 4. Save single-model Step 57 submission csv
        sub_path = out_dir / "submission_step57_2step.csv"
        ...
        success_msg = (
            f"✅ Finished: [Step 57 inference.py] Spatiotemporal model test predictions generated successfully!\n"
        ...
        error_msg = f"❌ Failed: [Step 57 inference.py] Inference failed:\n{str(e)}\n\nTraceback:\n{traceback.format_exc()}"
