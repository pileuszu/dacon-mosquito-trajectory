...
def main():
    try:
        ...
        data_dir_active = Path("step61_spatiotemporal_ai/data")
        ...
        sub_path = out_dir / "submission_ultimate_blend_v61.csv"
        ...
        print(f"Step 61 Blending Complete. Blended OOF Hit Rate: {overall_blended_hr*100:.5f}%")
        
    except Exception as e:
        print(f"Step 61 Blending failed: {str(e)}\n{traceback.format_exc()}")
        sys.exit(1)
