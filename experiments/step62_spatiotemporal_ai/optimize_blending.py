...
def main():
    try:
        ...
        data_dir_active = Path("step62_spatiotemporal_ai/data")
        out_dir = Path("outputs/step62_spatiotemporal_ai")
        ...
        sub_path = out_dir / "submission_ultimate_blend_v62.csv"
        ...
        print(f"Step 62 Blending Complete. Blended OOF Hit Rate: {overall_blended_hr*100:.5f}%")
        
    except Exception as e:
        print(f"Step 62 Blending failed: {str(e)}\n{traceback.format_exc()}")
        sys.exit(1)
