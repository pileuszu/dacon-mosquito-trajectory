...
def main():
    ...
    Path("step36_four_regime/models").mkdir(parents=True, exist_ok=True)
    
    # 1. Slow-Straight
    train_regime_model(
        regime_name="SLOW_STRAIGHT",
        train_data_path="step36_four_regime/train_ranker_v36_slow_straight.csv",
        model_path="step36_four_regime/models/ranker_v36_slow_straight",
        time_limit=3600
    )
    ...
    train_regime_model(
        ...
        model_path="step36_four_regime/models/ranker_v36_fast_straight",
        time_limit=3600
    )
    ...
    train_regime_model(
        ...
        model_path="step36_four_regime/models/ranker_v36_slow_extreme_turning",
        time_limit=3600
    )
    ...
    train_regime_model(
        ...
        model_path="step36_four_regime/models/ranker_v36_fast_turning",
        time_limit=3600
    )
