...
from step42_3d_out_of_plane.prepare_data import extract_context_features, REGIME_MAPPING
...
def main():
    print("=== Step 42: Optimizing 3D Coordinate Blending Weights on Unbiased OOF Validation ===")
    ...
    print("Loading 3D OOF predictions...")
    oof_df = pd.read_csv("step42_3d_out_of_plane/data/oof_predictions_final.csv")
    ...
    print("Generating validation candidates and running 3D anisotropic smoothing...")
    ...
    print(f"\n3D Baseline (Anisotropic Smoothed only, no blending) Overall Hit@1cm: {overall_raw_hit:.4%}")
