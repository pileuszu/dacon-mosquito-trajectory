...
def run_hybrid_inference():
    ...
    # Load Hybrid Ranker
    model_path = 'step16/models/ranker_v16'
    ...
    print(f"Running Hybrid Step 16 Inference in batches...")
    ...
    out_path = Path("outputs/step16/submission.csv")
    out_path.parent.mkdir(parents=True, exist_ok=True)
    sub_df.to_csv(out_path, index=False)
    print(f"HYBRID Submission saved to {out_path}")
