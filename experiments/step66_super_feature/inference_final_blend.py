...
def main():
    send_discord_notification(None, "🚀 Started: [Step 66 inference_final_blend.py] Running Powell-Optimized Hybrid Continuous Ensemble & Snapping...")
    ...
    try:
        ...
        success_msg = f"✅ Finished: [Step 66 inference_final_blend.py] Final submission generated. Mean displacement: {diffs.mean()*100:.3f}cm, Easy snapped: {easy_snapped_count}"
        send_discord_notification(None, success_msg)
        
    except Exception as e:
        error_msg = f"❌ Failed: [Step 66 inference_final_blend.py] Final blend inference failed.\nError: {str(e)}\n\n{traceback.format_exc()}"
