...
def evaluate_step32_oof():
    print("Loading Step 32 training data and predictions...")
    df_slow = pd.read_csv('step32_dual_regime_ranker/train_ranker_v32_slow.csv')
    df_fast = pd.read_csv('step32_dual_regime_ranker/train_ranker_v32_fast.csv')
    
    print("Loading AutoGluon Predictors...")
    predictor_slow = TabularPredictor.load('step32_dual_regime_ranker/models/ranker_v32_slow')
    predictor_fast = TabularPredictor.load('step32_dual_regime_ranker/models/ranker_v32_fast')
