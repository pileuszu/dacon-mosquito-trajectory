...
def train_anisotropic_blending_ranker_v28():
    try:
        send_discord_notification(URL, "🚀 [Step 28] Anisotropic Blending Ranker V28 Training Started...")
        ...
        success_msg = (
            f"✅ [Step 28] Anisotropic Blending Ranker V28 Training Finished!\n"
        ...
        error_msg = f"❌ [Step 28] Training ERROR:\n{str(e)}\n\n{traceback.format_exc()}"
        send_discord_notification(URL, error_msg)
        print(error_msg)
        raise e

if __name__ == "__main__":
    train_anisotropic_blending_ranker_v28()
