...
def inference():
    ...
    model_path = 'step6_best_model.pth'
    ...
    print(f"Starting Discrete inference on {len(test_files)} samples...")
    with torch.no_grad():
    ...
    os.makedirs('outputs/step6', exist_ok=True)
    res_df.to_csv('outputs/step6/submission.csv', index=False)
    print(f"Submission saved to outputs/step6/submission.csv")
