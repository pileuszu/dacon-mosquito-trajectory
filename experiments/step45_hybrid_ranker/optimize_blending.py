...
from step45_hybrid_ranker.prepare_data import extract_context_features, REGIME_MAPPING
...
def main():
    print("=== Step 45: Optimizing Hybrid Classifier-Regressor Blending Weights on Unbiased OOF Validation ===")
    ...
    print("Loading Step 45 OOF predictions...")
    oof_df = pd.read_csv("step45_hybrid_ranker/data/oof_predictions_final.csv")
    ...
    print(f"\nStep 45 Baseline (Anisotropic Smoothed only, no blending) Overall Hit@1cm: {overall_raw_hit:.4%}")
