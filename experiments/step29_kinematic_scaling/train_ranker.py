...
def train_kinematic_scaling_ranker_v29():
    try:
        send_discord_notification(URL, "🚀 [Step 29] Kinematic Scaling Ranker V29 Training Started...")
        ...
        success_msg = (
            f"✅ [Step 29] Kinematic Scaling Ranker V29 Training Finished!\n"
        ...
        error_msg = f"❌ [Step 29] Training ERROR:\n{str(e)}\n\n{traceback.format_exc()}"
        send_discord_notification(URL, error_msg)
        print(error_msg)
        raise e

if __name__ == "__main__":
    train_kinematic_scaling_ranker_v29()
