...
def main():
    ...
    parser.add_argument("--out-dir", type=str, default="outputs/step50_frenet_ode", help="Output directory")
    args = parser.parse_args()
    
    # Send start notification
    send_discord_notification(
        None,
        f"🚀 Started: [Step 50 inference.py] Generating final Test predictions using 5-fold Frenet-Guided Neural ODE..."
    )
    ...
    try:
        ...
        if not available_folds:
            raise FileNotFoundError("No trained Frenet Neural ODE models found in step50_frenet_ode/models.")
        ...
        sub_path = out_dir / "submission_frenet_ode.csv"
        ...
        success_msg = (
            f"✅ Finished: [Step 50 inference.py] Test predictions successfully generated using {len(available_folds)}-fold ensemble!\n"
        ...
        error_msg = f"❌ Failed: [Step 50 inference.py] Blended inference failed:\n{str(e)}\n\nTraceback:\n{traceback.format_exc()}"
