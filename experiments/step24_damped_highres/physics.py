...
def get_candidate_specs():
    ...
    par_vals = [-0.5, 0.0, 0.4, 0.7, 1.0, 1.3, 1.6, 2.0]  # Full peak resolution restored!
    perp_vals = [-1.5, -1.0, -0.6, -0.3, -0.1, 0.0, 0.1, 0.3, 0.6, 1.0, 1.5]  # Full peak resolution restored!
    ts_vals = [0.7, 0.9, 1.0, 1.1, 1.3]  # Full peak resolution restored!
    damping_vals = [0.0, 0.5]  # Highly successful damping parameter selection!
...
def make_candidates(x, end_idx=-1, horizon=2):
    ...
    # Vectorized calculation for candidates
