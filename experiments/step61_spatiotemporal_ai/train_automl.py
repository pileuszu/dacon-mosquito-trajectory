...
def main():
    ...
    send_discord_notification(None, f"🚀 Started: [Step 61 train_automl.py] Training 5-fold Spatiotemporal model...")
    ...
    try:
        ...
        success_msg = f"✅ Finished: [Step 61] OOF 1-Step: {overall_hr_1*100:.3f}%, 2-Step: {overall_hr_2*100:.3f}%"
        send_discord_notification(None, success_msg)
        
    except Exception as e:
        error_msg = f"❌ Failed: [Step 61]\nError: {str(e)}\n\n{traceback.format_exc()}"
