...
def get_candidate_specs():
    specs = []
    d1_vals = [0.0, 0.5, 0.8, 1.0, 1.2] # Added 0.0 for Constant Position
    par_vals = [-1.0, 0.0, 0.5, 1.0, 1.5, 2.0]
    perp_vals = [-2.0, -1.0, -0.5, 0.0, 0.5, 1.0, 2.0]
    ts_vals = [0.6, 0.8, 1.0, 1.2, 1.4]
