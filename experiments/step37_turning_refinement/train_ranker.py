...
def main():
    ...
    train_regime_model(
        ...
        train_data_path="experiments/step36_four_regime/train_ranker_v36_slow_straight.csv",
    ...
    train_regime_model(
        ...
        train_data_path="experiments/step36_four_regime/train_ranker_v36_fast_straight.csv",
    ...
    train_regime_model(
        ...
        train_data_path="experiments/step36_four_regime/train_ranker_v36_slow_extreme_turning.csv",
    ...
    train_regime_model(
        ...
        train_data_path="experiments/step36_four_regime/train_ranker_v36_fast_turning.csv",
