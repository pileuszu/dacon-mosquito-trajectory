...
from step43_selective_3d_routing.prepare_data import extract_context_features, REGIME_MAPPING
...
def main():
    print("=== Step 43: Optimizing Selective 3D Grid Blending Weights on Unbiased OOF Validation ===")
    ...
    print("Loading Step 43 OOF predictions...")
    oof_df = pd.read_csv("step43_selective_3d_routing/data/oof_predictions_final.csv")
    ...
    print(f"\nStep 43 Baseline (Anisotropic Smoothed only, no blending) Overall Hit@1cm: {overall_raw_hit:.4%}")
