...
def train_hybrid_smoothing_ranker_v26():
    try:
        send_discord_notification(URL, "🚀 [Step 26] Hybrid + Smoothed Ranker V26 Training Started...")
        
        train_data_path = 'step26_hybrid_smoothing/train_ranker_v26.csv'
        ...
        success_msg = (
            f"✅ [Step 26] Hybrid + Smoothed Ranker V26 Training Finished!\n"
        ...
        error_msg = f"❌ [Step 26] Training ERROR:\n{str(e)}\n\n{traceback.format_exc()}"
        send_discord_notification(URL, error_msg)
        print(error_msg)
        raise e

if __name__ == "__main__":
    train_hybrid_smoothing_ranker_v26()
